...
const ProfilePage: React.FC = () => {
  const { address, balance, linkedWallets, removeLinkedWallet } = useWallet()
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 md:p-6 space-y-6">
      <h1 className="font-display text-2xl font-semibold text-qx-text-primary">Profile</h1>
      ...
      <Card>
        <div className="flex flex-col items-center text-center py-4">
          ...
          <div className="flex items-center gap-2">
            <h2 className="font-display text-lg font-semibold text-qx-text-primary">{profile.displayName || 'QF Holder'}</h2>
            <button
          ...
          <p className="text-xs text-qx-text-muted mt-1">Member since February 2026</p>
          <button
            onClick={handleCopy}
